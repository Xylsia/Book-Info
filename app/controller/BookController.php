<?php
    ...
    function findAllBooksByAuthor($first_name, $last_name) {
        $query =   "SELECT
                    ...
                    INNER JOIN publishers ON
                        books.publisher_id = publishers.publisher_id
                    WHERE
                        authors.first_name = '$first_name' and authors.last_name = '$last_name'
                    GROUP BY
                        books.title
                    ORDER BY
                        books.title ASC";
    ...
    function findAllBooksBetweenDates($date1, $date2) {
        $sql =     "SELECT
                        books.book_id AS book_id,
                        books.title,
                        books.content, 
                    ...
                    INNER JOIN publishers ON
                        books.publisher_id = publishers.publisher_id
                    WHERE 
                        books.publication_year BETWEEN '$date1' AND '$date2'
                    GROUP BY
                        books.title";
